...
route1 = Route.create!(title: "London Thames walking tour", user: user1, distance: rand(1.1..9.8).round(2), time: rand(10..59))
...
route2 = Route.create!(title: "Exploring Lisbon", user: user1, distance: rand(1.1..9.8).round(2), time: rand(10..59))
...
route3 = Route.create!(title: "Paris architecture", user: user1, distance: rand(1.1..9.8).round(2), time: rand(10..59))
